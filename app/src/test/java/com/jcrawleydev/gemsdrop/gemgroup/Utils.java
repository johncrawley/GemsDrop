...
public class Utils {
    ...
    public static GemGroup createGemGroup(GemGrid gemGrid, int initialPosition, GemGroup.Orientation orientation, Gem.Color c1, Gem.Color c2, Gem.Color c3, int borderWidth){
        Gem gem1 = new Gem(c1);
        Gem gem2 = new Gem(c2);
        Gem gem3 = new Gem(c3);
